...
# SSH SlowDNS
read -p "Enter SlowDNS Nameserver (or press enter for default): " -e -i "ns-fr.newdevs.uk" Nameserver
...
_default_obfs='odda'
_default_password='snilloc:odda10'
...
# Telegram IDs
My_Chat_ID='7336161072'
My_Bot_Key='8517942171:AAGwjST5_utAdSzUGvyChllf2uTCQuZ1qqE'
